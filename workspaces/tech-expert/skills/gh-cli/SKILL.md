---
name: gh-cli
description: GitHub CLI (gh) comprehensive reference for repositories, issues, pull requests, Actions, projects, releases, gists, codespaces, organizations, extensions, and all GitHub operations from the command line. Use when you need advanced or specific gh commands that aren't covered by standard instructions.
---
...
gh api /user --jq '.[] | select(.number > 100)'
